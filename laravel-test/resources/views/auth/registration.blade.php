                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('register.custom') }}" method="POST">
                            ...
                            <!-- add field -->
                            <div class="form-group mb-3">
                                <input type="text" placeholder="Student_Class" id="student_class" class="form-control" name="student_class" required autofocus>
                                @if ($errors->has('student_class'))
                                <span class="text-danger">{{ $errors->first('student_class') }}</span>
                                @endif
                            </div>
                            <div class="form-group mb-3">
                                <input type="text" placeholder="Student ID" id="student_id" class="form-control" name="student_id" required autofocus>
